...
class EditProductReviewSheet extends ConsumerStatefulWidget {
  const EditProductReviewSheet({super.key, this.productReview});

  final ShopingExperianceModel? productReview;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _EditProductReviewSheet();
}

class _EditProductReviewSheet extends ConsumerState<EditProductReviewSheet> {
  ...
  @override
  void initState() {
    rate = widget.productReview?.rating ?? 0;
    controller.text = widget.productReview?.comment ?? '';
    super.initState();
  }
            ...
            children: [
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      context.local.submit_rating_review,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            widget.productReview?.product.name ?? '',
                        ...
                        onPressed: () {
                          ...
                          if (formKey.currentState?.validate() ?? false) {
                            provider.addReviewProduct(
                              slug: widget.productReview?.product.slug ?? '',
                              qeury: {
                                "ratin": rate,
