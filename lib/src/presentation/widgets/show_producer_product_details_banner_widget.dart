...
class ShowProducerProductDetailsBannerWidget extends ConsumerWidget {
  final PageController pageController = PageController(initialPage: 0);

  ShowProducerProductDetailsBannerWidget({super.key});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final product = state.showMyProductBasicDetails;
            ...
            PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: CachedNetworkImageWidget(image: image.path),
                );
              },
            ),
