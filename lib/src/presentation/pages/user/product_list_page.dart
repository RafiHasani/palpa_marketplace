...
class ProductListPage extends ConsumerStatefulWidget {
  static const String path = '/productlist';

  final CategoryModel categoryModel;

  const ProductListPage({super.key, required this.categoryModel});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _ProductListPage();
}
...
class _ProductListPage extends ConsumerState<ProductListPage> {
  ...
  void loadData() {
    ...
    Future.microtask(() async {
      await provider.getCategoriesProductePageData(
          ...
          child: (state.apiCallStatus != .gettingCategoryProductPage)
              ? Column(
                  children: [
                    ...
                    HeadingRowWidget(
                      title:
                          ' ${widget.categoryModel.productsCount.toLocalNumber(locale)} '
                          '${context.local.product_in_category}'
